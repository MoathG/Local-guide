...
<head>
    ...
    <style>
        ...
        html,body{
            background-image: url('https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcRzEPs3CWB8jI5YaXN0HNVLZvCB6nmja1tBsKgETJFRhK8q0Ybnfg&s') ;
...
{{--                        </label>--}}
                        ...
                        <label class="row align-items-center remember" for="remember">Remember Me </label>
                    </div>
